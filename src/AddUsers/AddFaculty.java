 ...
 * @author HP
 */
public class AddFaculty extends JPanel 
{
   ...
   JFrame AddUser;
    ...
    /*---------------Labels----------------------------*/    
      AddUser=new JFrame("Faculty Registration Form");
        ...
        l6=new JLabel("                      ");
        l7=new JLabel("                      ");
        l8=new JLabel("Faculty Registation Form");
    ...
    public AddFaculty(String name,String email,ResultSet rs)
    {
    ...
    */
    ...
    {
     int i;
     i=db.insertFacultyData(namefield.getText(), branchbox.getSelectedItem().toString(), mobilefield.getText(), emailfield.getText(), passwordfield.getText());
     ...
     {
         JOptionPane.showMessageDialog(namefield,"USER IS SUCCESSFULLY REGISTERED","USER REGISTRATION",JOptionPane.INFORMATION_MESSAGE);
         clear();
     }
    ...
    {
      int i=db.updateFacultyProfile(oldemail,emailfield.getText(),passwordfield.getText(),namefield.getText(),branchbox.getSelectedItem().toString(),mobilefield.getText());
