 ...
 * @author HP
 */
public class UpdateFacultyDetails extends JPanel implements UpdateUserFunction
{
    ...
    public UpdateFacultyDetails() 
    {
     /*-------------------Frame and Panel---------------*/
        ...
        p1.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLoweredBevelBorder(),"Please Fill Up Faculty Details"));
    ...
    /*---------------Labels----------------------------*/    
        ...
        l6=new JLabel("                      ");
        l7=new JLabel("                      ");
        l8=new JLabel("UPDATE FACULTY DETAILS");
...
emailfield.addFocusListener(new FocusListener() {
    ...
    else
    {
        try
        {
          ResultSet rs=db.getUserDetailsForProfile("faculty","email",emailfield.getText());
            if(rs.next())
            {    
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        else if(branchbox.getSelectedIndex()==0)
       {
        ...
        else
        {
            ...
            try
            {
                i=db.updateFacultyProfile(emailfield.getText(), emailfield.getText(), passwordfield.getText(), namefield.getText(), branchbox.getSelectedItem().toString(), mobilefield.getText());
                if(i==1)
                {
